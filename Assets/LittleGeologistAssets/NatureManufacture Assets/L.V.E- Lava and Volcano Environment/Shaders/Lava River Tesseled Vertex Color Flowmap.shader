Shader "NatureManufacture Shaders/Lava/Lava River Tesseled Vertex Color Flowmap"
{
	...
	SubShader
	{
		...
		{
			float2 uv_ColdLavaAlbedo_SM = v.texcoord.xy * _ColdLavaAlbedo_SM_ST.xy + _ColdLavaAlbedo_SM_ST.zw;
			...
			float2 temp_output_1143_0 = ( uv_ColdLavaAlbedo_SM + ( appendResult1078 * temp_output_1139_0 ) );
			...
			float2 uv_MediumLavaAlbedo_SM = v.texcoord.xy * _MediumLavaAlbedo_SM_ST.xy + _MediumLavaAlbedo_SM_ST.zw;
			...
			float2 temp_output_1213_0 = ( uv_MediumLavaAlbedo_SM + ( appendResult1208 * temp_output_1139_0 ) );
			...
			float2 MediumFlowUV21227 = ( uv_MediumLavaAlbedo_SM + ( appendResult1208 * temp_output_1137_0 ) );
			...
			float2 uv_HotLavaAlbedo_SM = v.texcoord.xy * _HotLavaAlbedo_SM_ST.xy + _HotLavaAlbedo_SM_ST.zw;
			...
			float2 temp_output_1243_0 = ( uv_HotLavaAlbedo_SM + ( appendResult1238 * temp_output_1139_0 ) );
			float2 HotFlowUV11257 = temp_output_1243_0;
			half4 tex2DNode861 = tex2Dlod( _HotLavaMT_AO_H_EM, half4( HotFlowUV11257, 0, 1.0) );
			float2 HotFlowUV21258 = ( uv_HotLavaAlbedo_SM + ( appendResult1238 * temp_output_1137_0 ) );
		...
		{
			float2 uv_ColdLavaAlbedo_SM = i.uv_texcoord * _ColdLavaAlbedo_SM_ST.xy + _ColdLavaAlbedo_SM_ST.zw;
			int Direction723 = _UVVDirection1UDirection0;
			float2 appendResult705 = (half2(_ColdLavaMainSpeed.y , _ColdLavaMainSpeed.x));
			float2 WaterSpeedValueMain614 = (( (float)Direction723 == 1.0 ) ? _ColdLavaMainSpeed :  appendResult705 );
			float2 break1202 = WaterSpeedValueMain614;
			...
			float2 uv_MediumLavaAlbedo_SM = i.uv_texcoord * _MediumLavaAlbedo_SM_ST.xy + _MediumLavaAlbedo_SM_ST.zw;
			float2 appendResult710 = (half2(_MediumLavaMainSpeed.y , _MediumLavaMainSpeed.x));
			float2 SmallCascadeSpeedValueMain600 = (( (float)Direction723 == 1.0 ) ? _MediumLavaMainSpeed :  appendResult710 );
			float2 break1204 = SmallCascadeSpeedValueMain600;
			...
			float2 uv_HotLavaAlbedo_SM = i.uv_texcoord * _HotLavaAlbedo_SM_ST.xy + _HotLavaAlbedo_SM_ST.zw;
			float2 appendResult712 = (half2(_HotLavaMainSpeed.y , _HotLavaMainSpeed.x));
			float2 BigCascadeSpeedMain608 = (( (float)Direction723 == 1.0 ) ? _HotLavaMainSpeed :  appendResult712 );
			float2 break1235 = BigCascadeSpeedMain608;
			...
			float2 panner646 = ( _SinTime.x * ( temp_output_743_0 * float2( -1.2,-0.9 ) ) + uv_Noise);
			float2 panner321 = ( _SinTime.x * temp_output_743_0 + uv_Noise);
