Shader "NatureManufacture Shaders/Lava/Lava River Tesseled Vertex Color Flowmap Cheap"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 temp_output_1213_0 = ( uv_ColdLavaAlbedo_SM + ( appendResult1208 * temp_output_1139_0 ) );
			...
			float2 temp_output_1243_0 = ( uv_ColdLavaAlbedo_SM + ( appendResult1238 * temp_output_1139_0 ) );
			float2 HotFlowUV11257 = temp_output_1243_0;
			half4 tex2DNode861 = tex2Dlod( _ColdLavaMT_AO_H_EM, half4( HotFlowUV11257, 0, 1.0) );
			float2 HotFlowUV21258 = ( uv_ColdLavaAlbedo_SM + ( appendResult1238 * temp_output_1137_0 ) );
